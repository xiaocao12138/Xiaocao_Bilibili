package com.myproject.bilibili.model.live.adapter;
...
public class RecommendLiveAdapter extends BaseAdapter {
   ...
   /* public RecommendLiveAdapter(Context mContext, List<LIveRecomendBean.DataBean.RecommendDataBean.LivesBean> lives) {
